...
class BerlinClockTest extends TestCase{
    ...
    public function test_countBlockOfFiveHours_given10_shouldReturn2R(){
        $actual = $this->actCountBlockOfFiveHours(10);

        $this->assertEquals("2R", $actual);
    }

    public function test_countBlockOfFiveHours_given15_shouldReturn3R(){
        $actual = $this->actCountBlockOfFiveHours(15);

        $this->assertEquals("3R", $actual);
    }

    public function test_countBlockOfFiveHours_given20_shouldReturn4R(){
        $actual = $this->actCountBlockOfFiveHours(20);
    ...
    public function test_countSeconds_given3_shouldReturn1R(){
    ...
    private function actCountSeconds(int $int): string{
        return $this->berlinClock->countSeconds($int);
    }
}
